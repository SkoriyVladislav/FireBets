...
public class GoToUserProfile implements ICommand {
    private Receiver receiver;

    public GoToUserProfile(Receiver receiver) {
        this.receiver = receiver;
    }

    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        receiver.action(TypeCommand.GO_TO_USER_PROFILE, request, response);
    }
}
